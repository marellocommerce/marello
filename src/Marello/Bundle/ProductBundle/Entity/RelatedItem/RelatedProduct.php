...
#[ORM\Table(name: 'marello_product_related_products')]
#[ORM\Index(columns: ['product_id'], name: 'idx_marello_product_related_products_product_id')]
#[ORM\Index(columns: ['related_item_id'], name: 'idx_marello_product_related_products_related_item_id')]
#[ORM\UniqueConstraint(name: 'idx_marello_product_related_products_unique', columns: ['product_id', 'related_item_id'])]
#[Oro\Config(
    defaultValues: [
        'ownership' => [
...
class RelatedProduct implements
