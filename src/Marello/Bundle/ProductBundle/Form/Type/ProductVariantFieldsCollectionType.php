...
use Marello\Bundle\ProductBundle\Provider\VariantFieldProvider;
use Marello\Bundle\ProductBundle\Form\DataTransformer\ProductVariantFieldsTransformer;

/**
 * Product variant fields collection type.
 */
class ProductVariantFieldsCollectionType extends AbstractType
{
    const NAME = 'marello_product_variant_fields_collection';
