...
class TicketType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add(
                'source',
                TicketSourceSelectType::class,
                ['label' => 'marello.ticket.source.label', 'required' => true]
            );
//            ->add(
//                'priority',
//                TicketPrioritySelectType::class,
//                ['label' => 'marello.ticket.priority.label', 'required' => true]
//            )
...
//                'resolution',
//                TextareaType::class,
//                ['label' => 'marello.ticket.resolution.label', 'required' => false]
//            );
    }
