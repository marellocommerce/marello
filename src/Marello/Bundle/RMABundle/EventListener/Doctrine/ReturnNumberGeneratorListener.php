...
namespace Marello\Bundle\RMABundle\EventListener\Doctrine;
...
class ReturnNumberGeneratorListener
{
    ...
    public function onFlush(OnFlushEventArgs $args)
    {
        ...
        foreach ($insertions as $entity) {
            if ($entity instanceof ReturnEntityInterface) {
                $this->returns[] = $entity;
            }
        }
    }
     ...
     *
     * @param ReturnEntityInterface[] $returns
     *
     * @return ReturnEntityInterface[] Array of changed returns.
     */
